...
POS_FIELD_MAPPING: Dict[str, str] = {
    ...
    "exercise_new_exercises": "pos_exercise_new_exercises",
    "exercise_new_exercises_name": "pos_exercise_new_exercises_name",
    "exercise_new_questions": "pos_exercise_new_questions",
    "exercise_new_questions_name": "pos_exercise_new_questions_name",
    "exercise_new_choices": "pos_exercise_new_choices",
    "exercise_new_choices_name": "pos_exercise_new_choices_name",
    ...
    "question_new_questions": "pos_question_new_questions",
    "question_new_questions_name": "pos_question_new_questions_name",
    "question_new_choices": "pos_question_new_choices",
    "question_new_choices_name": "pos_question_new_choices_name",
